...
/**
 * "Feel the Change" CTA — peelable burger-boy sticker, popping headline,
 * masked-line paragraph, morphing Order Now blob and the CTA photo.
 */
export default function CtaSection() {
  return (
    <div className="-mt-[18vw]">
      <section id="cta" className="h-fit w-full pt-[18vw] max-md:pt-[12vw] overflow-clip relative bg-beige">
